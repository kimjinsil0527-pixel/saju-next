...
export default function RefundPage() {
  return (
    <main style={{ maxWidth: 760, margin: '0 auto', padding: '80px 24px', color: '#e8d9b5', fontFamily: 'serif', lineHeight: 1.8 }}>
      ...
      <p style={{ opacity: 0.5, marginBottom: 48 }}>Last updated: June 12, 2026</p>

      <p>This Refund Policy applies to purchases made through UNMYUNG ("we", "our", "the Service"). Transactions are processed by <strong>Lemon Squeezy</strong>, our Merchant of Record, which handles billing, applicable taxes, and approved refund processing.</p>
      ...
      <p>Our Cookie Membership and unlocked readings are digital services delivered immediately after payment or Cookie confirmation. <strong>By completing your purchase, you acknowledge that:</strong></p>
      ...
      <h2 style={{ marginTop: 32 }}>4. Monthly Cookie Membership</h2>
      <p>For the monthly Cookie Membership:</p>
      <ul style={{ paddingLeft: 24, marginTop: 8 }}>
        <li>Each successful monthly payment grants 35 Cookies.</li>
        <li>You may cancel using the Lemon Squeezy customer portal from your receipt or by contacting support.</li>
        <li>Cancellation prevents future renewals but does not remove unused Cookies already in your wallet.</li>
        <li>Refund eligibility depends on Cookie usage, service delivery, Lemon Squeezy's process, and applicable consumer law.</li>
      </ul>

      <h2 style={{ marginTop: 32 }}>5. Technical Failures</h2>
      ...
      <h2 style={{ marginTop: 32 }}>6. How to Request a Refund</h2>
      ...
      <p>We will respond within 3 business days. Approved refunds are processed through Lemon Squeezy, and arrival time depends on the original payment method.</p>

      <h2 style={{ marginTop: 32 }}>7. Chargebacks & Disputes</h2>
      ...
      <h2 style={{ marginTop: 32 }}>8. Merchant of Record</h2>
      <p>Payments are processed by <strong>Lemon Squeezy</strong> as Merchant of Record. Lemon Squeezy's own terms and refund procedures may also apply.</p>
